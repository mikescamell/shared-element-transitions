...
public class RecyclerViewActivity extends AppCompatActivity implements AnimalItemClickListener {
    ...
    @Override
    public void onAnimalItemClick(AnimalItem animalItem, ImageView shareImageView) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            intent.putExtra(EXTRA_ANIMAL_IMAGE_TRANSITION_NAME, shareImageView.getTransitionName());
            options = ActivityOptionsCompat.makeSceneTransitionAnimation(
                    this,
                    shareImageView,
                    shareImageView.getTransitionName());
        }
